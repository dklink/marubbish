...
% chl: ambient chlorophyll concentration at the particle's location (kg m^-3)
% I: light intensity at the particle's location (mol quanta m^-2 s^-1)
% return: time derivative of number of algal cells attached to particle (# algal cells m^-2 s^-1)
